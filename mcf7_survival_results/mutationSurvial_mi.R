...
mutList = read.table('DNB_time5_whole_time5',sep = '\t',header = T,row.names = 1)
...
pdf("brca_mutGenes_kmCurve_0,05_mi.pdf")
pval_vec = vector()
...
write.table(pval.brca.sig,file="brca_mutGene_survival_mi.txt",sep="\t",quote=F,row.names = F)
